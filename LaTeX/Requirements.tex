...
\begin{itemize}
\itemRespond almost instantly in terms of creation and deletion of a Buzz space.
\itemRespond to the creation and deletion of threads as well as the management or administration of the whole system.
\itemBe able to handle high contention where a lot of concurrent users will want to access an actice buzz space at once where they should not experience latency or be susceptible to data traffic.
\end{itemize}
